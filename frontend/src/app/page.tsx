...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[var(--bg-primary)] text-slate-100">
      ...
      <div className="relative mx-auto grid min-h-screen max-w-[2200px] grid-cols-1 gap-6 px-6 py-6 xl:grid-cols-[88px_1fr_420px]">
        <aside className="panel-premium flex h-full min-h-[90vh] flex-col p-3">
